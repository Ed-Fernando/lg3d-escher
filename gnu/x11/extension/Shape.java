...
public class Shape extends Extension implements EventFactory {
  ...
  public Shape (Display display) throws NotFoundException { 
    ...
    XProtocolInfo.extensionRequestExpectsReply(major_opcode, 5, 32); // QueryExtents
    XProtocolInfo.extensionRequestExpectsReply(major_opcode, 6, 32); // InputSelected
    XProtocolInfo.extensionRequestExpectsReply(major_opcode, 8, 32); // GetRectangles
