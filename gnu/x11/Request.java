...
public class Request extends Data {
  ...
  static abstract class Aggregate extends Request {
    ...
    public abstract void write (EscherOutputStream out) throws IOException;
  }
  ...
  public static class ValueList extends Aggregate {
    ...
    public void write (EscherOutputStream out) throws IOException {  
      unit += vl.count ();
      init (display, opcode, 0, unit);
  ...
  public static abstract class Poly extends Aggregate {
    ...
    public static class Fill extends Poly {
      ...
      public void write (EscherOutputStream out, Object item)
        throws IOException {
    ...
    public static class Arc extends Poly {
      ...
      public void write (EscherOutputStream out, Object item) throws IOException {    
    ...
    public abstract void write (EscherOutputStream out, Object item) 
      throws IOException;
