...
public class Window extends Drawable {
  ...
  public static class AttributesReply extends Data {
    ...
    public int root () { return read1 (26); }
  ...
  public static class WMSizeHints extends Data {
    ...
    public int max_width () { return read4 (60); }
    public int max_height () { return read4 (64); }
    public int inc_width () { return read4 (68); }
    public int inc_height () { return read4 (72); }
    
    public boolean presizeIncrement () {
        return ((flags () & PRESIZE_INC_MASK) == 0) ? false : true;
    }
